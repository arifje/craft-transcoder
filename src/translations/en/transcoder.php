...
return [
    ...
    'Overlay the selected image on encoded videos. Existing encoded files are left alone until they are regenerated.' => 'Overlay the selected image on encoded videos. Existing encoded files are left alone until they are regenerated.',
    'Watermark image' => 'Watermark image',
    'Choose a PNG, JPG, or SVG asset to overlay on encoded videos.' => 'Choose a PNG, JPG, or SVG asset to overlay on encoded videos.',
    'Choose a PNG, JPG, or SVG asset to overlay on encoded videos. The configured path/URL below takes precedence when present.' => 'Choose a PNG, JPG, or SVG asset to overlay on encoded videos. The configured path/URL below takes precedence when present.',
    'Watermark file path' => 'Watermark file path',
    'Optional local path or alias, such as @webroot/content/general/watermark.svg. This is checked before the selected asset and is useful for production config.' => 'Optional local path or alias, such as @webroot/content/general/watermark.svg. This is checked before the selected asset and is useful for production config.',
    'Watermark URL' => 'Watermark URL',
    'Optional remote PNG, JPG, or SVG URL. Used when no watermark file path is configured, before falling back to the selected asset.' => 'Optional remote PNG, JPG, or SVG URL. Used when no watermark file path is configured, before falling back to the selected asset.',
